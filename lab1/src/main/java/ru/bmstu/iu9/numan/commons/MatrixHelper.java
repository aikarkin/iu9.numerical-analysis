...
public class MatrixHelper {
    public static double vecDist(RealVector[] x, RealVector[] xPrev) {
//        double squares = 0;
//
//        for (int i = 0; i < x.length; i++) {
//            for (int j = 0; j < x[i].getDimension(); j++) {
//                squares += (x[i].getEntry(j) - xPrev[i].getEntry(j)) *  (x[i].getEntry(j) - xPrev[i].getEntry(j));
//            }
//        }
//
//        return sqrt(squares);
    ...
    public static RealVector joinVectors(RealVector[] vectors) {
    ...
    public static RealMatrix toTridiagonal(RealMatrix matrix) {
    ...
    public static void printVector(RealVector vector, String caption, Object ...params) {
        ...
        for (int i = 0; i < vector.getDimension(); i++) {
            System.out.printf("%.3f ", vector.getEntry(i));
        }

        System.out.println();
    }

    public static RealMatrix inverseOfTridiagonal(final RealMatrix matrix) {
